...
try {
    $stmt = $con->prepare("DELETE FROM `bestoffer` WHERE OfferId = :OfferId AND UserEmail = :UserEmail");
    ...
    if ($count > 0) {
        ...
        echo json_encode(array("status" => "fail", "message" => "Best offer not found or no changes were made"));
    }
